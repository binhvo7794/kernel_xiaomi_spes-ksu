...
if [ ! -d "$TOOLCHAIN_DIRECTORY" ]; then
    ...
    wget -q https://android.googlesource.com/platform//prebuilts/clang/host/linux-x86/+archive/3857008389202edac32d57008bb8c99d2c957f9d/clang-r383902.tar.gz -O file.tar.gz
...
git clone --depth=1 https://github.com/binhvo7794/AnyKernel3 anykernel
